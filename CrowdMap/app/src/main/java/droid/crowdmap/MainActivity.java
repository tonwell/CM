...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    int i;
    private double[] scales = { 0.002, 0.004, 0.008, 0.016, 0.032, 0.064, 0.128, 0.256, 0.512, 1.024, 2.048, 4.096,
            8.192, 16.384, 32.768, 65.536 };
    private float[] zooms = { 15.879104f, 14.905452f, 13.954487f, 12.933992f, 11.941226f, 10.953466f, 9.950232f,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(this,
            ...
            if (map == null)
                Toast.makeText(this, "Mapa nulo", Toast.LENGTH_LONG).show();
    ...
    public void fillQuads(Dados d, double scale) {
         ...
         * gmap.addPolygon( DrawAPI.fillQuad(quad, scale, d.getSinal())); Log.i( "QUAD"
         * , "lat: " + quad.latitude + "lng: " + quad.longitude); Log.i( "DadosQuad",
         * "lat: " + d.getLatitude() + "lng: " + d.getLongitude() ); /
         */
        LatLng quad = new LatLng(DrawAPI.getIdCoord(d.getLatitude(), scale),
                DrawAPI.getIdCoord(d.getLongitude(), scale));
        gmap.addPolygon(DrawAPI.fillQuad(quad, scale, d.getSinal()));
        Log.i("CMMainActivity", "QUAD ::lat: " + quad.latitude + ", lng: " + quad.longitude);
        Log.i("CMMainActivity", "DadosQuad :: lat: " + d.getLatitude() + ", lng: " + d.getLongitude());
        // */
    }
    ...
    protected void onPause() {
        super.onPause();
        /*
         * if(task1 != null && isFinishing()) task1.cancel(false) ;
         */
    }
