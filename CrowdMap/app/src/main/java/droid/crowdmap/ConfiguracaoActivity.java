...
public class ConfiguracaoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtColeta.setText(String.valueOf(sp.getLong("minutos", 20L)), TextView.BufferType.EDITABLE);
        ...
        final int progress = (int) sp.getLong("sqlite", 20L);
        sbSqlite.setProgress(progress);
        ...
        btnApply.setOnClickListener(v -> {
            ...
            if (!edtTxt.isEmpty() && Integer.valueOf(edtTxt) != 0 && sqlite != 0 && cache != 0) {
                sp.edit()
                        .putLong("minutos", Long.valueOf(edtTxt))
                        .putInt("sqlite", sqlite)
                        .putInt("cache", cache)
                        .apply();
