...
public class MainActivityB extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap mapa) {
        ...
        gmap.setOnCameraChangeListener(new OnCameraChangeListener() {
            ...
            public void onCameraChange(CameraPosition cameraPosition) {
                gmap.clear();
                int i;
                if(cameraPosition.zoom > zooms[0]){
                    i = 0;
                } else if(cameraPosition.zoom > zooms[1]){
                    i = 1;
                } else if(cameraPosition.zoom > zooms[2]){
                    i = 2;
                } else if(cameraPosition.zoom > zooms[3]){
                    i = 3;
                } else if(cameraPosition.zoom > zooms[4]){
                    i = 4;
                } else if(cameraPosition.zoom > zooms[5]){
                    i = 5;
                } else if(cameraPosition.zoom > zooms[6]){
                    i = 6;
                } else if(cameraPosition.zoom > zooms[7]){
                    i = 7;
                } else if(cameraPosition.zoom > zooms[8]){
                    i = 8;
                } else if(cameraPosition.zoom > zooms[9]){
                    i = 9;
                } else if(cameraPosition.zoom > zooms[10]){
                    i = 10;
                } else if(cameraPosition.zoom > zooms[11]){
                    i = 11;
                } else if(cameraPosition.zoom > zooms[12]){
                    i = 12;
                } else if(cameraPosition.zoom > zooms[13]){
                    i = 13;
                } else if(cameraPosition.zoom > zooms[14]){
                    i = 14;
                } else {
                    i = 15;
                }
    ...
    class GetQuadTask extends AsyncTask<Dados,Void,Dados>{
        DB dao;
        MainActivityB activity;
        double scale;

        public GetQuadTask(MainActivityB activity, double scale){
